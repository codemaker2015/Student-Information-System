...
Begin VB.Form StudentFrm 
   ...
   Begin TabDlg.SSTab SSTab_AddStudent 
      ...
      TabPicture(0)   =   "StudentFrm.frx":0000
      ...
      Tab(0).Control(11)=   "Label36"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "Religion"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "Label3"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "Label20"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "txtDOB"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "Container4"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "cmdNext1"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "jcbutton1"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "txtmContact"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "txtPOB"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "txtID"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "cboReligion"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "txtLname"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "cboDept"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "cboStatus"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "cboBloodType"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "txtAdd"
      ...
      TabPicture(1)   =   "StudentFrm.frx":001C
      ...
      TabPicture(2)   =   "StudentFrm.frx":0038
      ...
      TabPicture(3)   =   "StudentFrm.frx":0054
      ...
      Begin VB.ComboBox cboBloodType 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "StudentFrm.frx":052F
         Left            =   1320
         List            =   "StudentFrm.frx":053F
         TabIndex        =   6
         Top             =   4200
         Width           =   2745
      End
      Begin VB.ComboBox cboStatus 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "StudentFrm.frx":0550
         Left            =   1320
         List            =   "StudentFrm.frx":055D
         TabIndex        =   5
         Top             =   3840
         Width           =   2775
      End
      Begin VB.ComboBox cboDept 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "StudentFrm.frx":0579
         Left            =   1320
         List            =   "StudentFrm.frx":0583
         TabIndex        =   2
         Text            =   "--Select--"
         Top             =   2040
         Width           =   2775
...
rtbInfo.Text = ""
    ...
    rtbInfo.Text = rtbInfo.Text & _
    "Name: " & Me.txtLname.Text & ", " & " " & vbNewLine
    
    rtbInfo.Text = rtbInfo.Text & _
    "Gender: " & Me.cboDept.Text & vbNewLine
